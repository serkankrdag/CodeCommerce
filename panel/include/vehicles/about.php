<?php function about() { global $db;
        ...
        if ($_FILES) {
            ...
            if ($_FILES["picture"]["size"]  > 1000000) {
                ...
                if ($dosyaUzantisi != "jpeg" && $dosyaUzantisi != "jpg" && $dosyaUzantisi != "png") {
                    ...
                    $sorgu = $db->query("select * from about where id='1'")->fetch();
                    $file = "../upload/about/".$sorgu['picture'];
        ...
        if($ekle) {
            $controle=
                ...
                <div class="alert alert-success d-flex align-items-success p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Hakkımızda Düzenlendi</h4>
                        <span>Hakkımızda Düzenleme işlemi başarılı bir şekilde gerçekleşti.</span>
                    </div>
                </div>
                ';
        } elseif (!$ekle) {
            $controle=
                ...
                <div class="alert alert-danger d-flex align-items-danger p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Hakkımızda Düzenlenemedi</h4>
                        <span>Hakkımızda Düzenleme işlemi başarısız lütfen bütün alanları doldurun.</span>
                    </div>
                </div>
                ';
        }
    ...
    breadcrumb('Kontrol Panel','Araçlar','Hakkımızda'); ?>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body text-center pt-0">
                                    <style>
                                        ...
                                        <?php if (isset($about['picture']) && !empty($about['picture'])) { ?>
                                            background-image: url(../upload/about/<?=$about["picture"]?>);
                                        <?php } else { ?>
                                    ...
                                    <div class="text-muted fs-7">Hakkımızda küçük resmini ayarlayın. Yalnızca *.png, *.jpg ve *.jpeg resim dosyaları kabul edilir</div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        <label class="required form-label">Hakkımızda Başlık</label>

                                        <input type="text" name="title" class="form-control mb-2" placeholder="Hakkımızda Başlık" value="<?=$about['title']?>">

                                        <div class="text-muted fs-7">Bir hakkımızda başlığı gereklidir ve benzersiz olması önerilir.</div>
                                        <div class="fv-plugins-message-container invalid-feedback"></div></div>

                                    <div>
                                        <label class="form-label">Tanım</label>

                                        <textarea class="form-control mb-2" name="description" id="description" cols="30" rows="10"><?=$about['description']?></textarea>
                                        <div class="text-muted fs-7">Daha iyi görünürlük için hakkımızda bir açıklama ayarlayın.</div>
                                    </div>
                                </div>
                            </div>
