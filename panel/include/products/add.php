<?php function productsAdd() { global $db;
    ...
    if ($_POST) {
        ...
        foreach($_FILES['pictures']['tmp_name'] as $key => $tmp_name){
            $dosyaUzantisi = pathinfo($_FILES["pictures"]["name"][$key], PATHINFO_EXTENSION);
            $pictures = time()  . $key . '.' . $dosyaUzantisi;
            $yuklemeYeri = $yol . $pictures;
            if ($_FILES["pictures"]["size"][$key]  > 1000000) {
                ...
                if ($dosyaUzantisi != "jpeg" && $dosyaUzantisi != "jpg" && $dosyaUzantisi != "png") {
                    ...
                    $sonuc = move_uploaded_file($tmp_name, $yuklemeYeri);
                    $pictureArray[] = $pictures;
                }
            }
        }
        if (isset($pictureArray)) {
            $json = json_encode($pictureArray);
            $dosyaYukleme2 = "pictures = '$json',";
        } else { $dosyaYukleme2 = ''; }
        ...
        if ($name!='' && $description!='' && $status!='' && $category!='' && $brand!='' && $picture!=''
        ...
        if (isset($_POST["options"])) {
            ...
            $keyyy = count($_POST["options"]);
            for ($i=0;$i<$keyyy;$i++) {
                $option[]=$options[$i]['option'];
                if ($option!='') {
                    $optionEkle = json_encode($option, JSON_UNESCAPED_UNICODE);
                    $ekle = $db->exec("
                        update products set 
                        optionUrun = '$optionEkle'
                        where id = '$lastId';
                    ");
                }
            }
        ...
        if (isset($_POST["varyant"])) {
            ...
            $keyy = count($_POST["varyant"]);
            for ($i=0;$i<$keyy;$i++) {
                foreach($variants as $key => $variant) {
                    $variantGroup = $variant['name'];
                    if (isset($contents[$i]['contents'.$key])) {
                        $contentss=json_encode($contents[$i]['contents'.$key], JSON_UNESCAPED_UNICODE);
                        if ($contentss!='') {
                            $ekle = $db->exec("
                            insert into variantOptions set 
                            variantGroup = '$variantGroup',
                            variantContent = '$contentss',
                            groupId = '$i',
                            productId = '$lastId'
                        ");
                        }
        ...
        if($ekle) {
            $controle=
                ...
                <div class="alert alert-success d-flex align-items-success p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Ürün Eklendi</h4>
                        <span>Ürün ekleme işlemi başarılı bir şekilde gerçekleşti.</span>
                    </div>
                </div>
                ';
        } elseif (!$ekle) {
            $controle=
                ...
                <div class="alert alert-danger d-flex align-items-danger p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Ürün Eklenemedi</h4>
                        <span>Ürün ekleme işlemi başarısız lütfen bütün alanları doldurun.</span>
                    </div>
                </div>
                ';
        }
    ...
    breadcrumb('Kontrol Panel','Ürünler','Ürün Ekleme'); ?>
                    ...
                    <form method="post" class="form d-flex flex-column flex-lg-row fv-plugins-bootstrap5 fv-plugins-framework" enctype="multipart/form-data">
                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                            ...
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                    <div class="card-title">
                                        <h2>Haftalık Satış</h2>
                                    </div>
                                </div>

                                <div class="card-body pt-0">
                                    <span class="text-muted">Veri yok. Ürün yayınlandıktan sonra satış verileri yakalanmaya başlar.</span>
                                </div>
                            </div>
                            <div class="card card-flush py-4">
                                <div class="card-header">
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="name" class="form-control mb-2" placeholder="Ürün adı" value="">
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="price" class="form-control mb-2" placeholder="Taban Fiyat" value="">
                                                    ...
                                                    <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']" data-kt-initialized="1">
                                                        <div class="col">
                                                            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary active d-flex text-start p-6" data-kt-button="true">
                                                                <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                    <input class="form-check-input" type="radio" name="discountType" value="1" checked="checked">
                                                                </span>
                                                        ...
                                                        <div class="col">
                                                            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary  d-flex text-start p-6" data-kt-button="true">
                                                                <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                    <input class="form-check-input" type="radio" name="discountType" value="2">
                                                                </span>
                                                        ...
                                                        <div class="col">
                                                            <label class="btn btn-outline btn-outline-dashed btn-active-light-primary d-flex text-start p-6" data-kt-button="true">
                                                                <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start mt-1">
                                                                    <input class="form-check-input" type="radio" name="discountType" value="3">
                                                                </span>
                                                ...
                                                <div class="d-flex flex-wrap gap-5">
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <input name="discount" type="text" class="form-control mb-2" value="">
                                                    ...
                                                    <div class="fv-row w-100 flex-md-root">
                                                        ...
                                                        <input name="kdv" type="text" class="form-control mb-2" value="">
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="stockCode" class="form-control mb-2" placeholder="Stok Kodu" value="">
                                                ...
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <input type="text" name="barcode" class="form-control mb-2" placeholder="Barkod numarası" value="">
                                                ...
                                                <div class="mb-10 fv-row fv-plugins-icon-container">
                                                    ...
                                                    <div class="d-flex gap-3">
                                                        <input type="number" name="stockShelf" class="form-control mb-2" placeholder="Rafta" value="">
                                                        <input type="number" name="stockTank" class="form-control mb-2" placeholder="Depoda">
                                                    </div>
                                                                ...
                                                                <div data-repeater-list="varyant">
                                                                    <div data-repeater-item>
                                                                        <div class="form-group row mb-5">
                                                                            <?php $variants = $db->query("select * from variants where status = '1' order by id ASC")->fetchAll();
                                                                            foreach($variants as $key => $variant) { ?>
                                                                                <div class="col-md-3">
                                                            ...
                                                            <div class="form-group">
                                                                <div data-repeater-list="options">
                                                                    <div class="col-md-5">
                                                                        ...
                                                                        <input type="text" id="secenekfiyat" name="secenekfiyat" class="form-control mb-5" placeholder="Ürün Seçenek Fiyat" value="">
                                                                    </div>
                                                                    <div data-repeater-item>
                                                                        <div class="form-group row mb-5">
                                                                            <div class="col-md-3">
                                                                                <input type="text" name="option" class="form-control mb-2" placeholder="Ürün Seçenek" value="">
                                                                            </div>
                                                                            <div class="col-md-2">
                                                                                <a href="javascript:;" data-repeater-delete class="btn btn-sm btn-light-danger mt-2mb2">
                                                                                    <i class="la la-trash-o fs-3"></i>Sil
                                        ...
                                        <div class="card card-flush py-4">
                                            ...
                                            <div class="card-body pt-0">
                                                <div class="mb-10">
                                                    ...
                                                    <input type="text" class="form-control mb-2" name="metaTitle" placeholder="Meta tag name">
                                                ...
                                                <div class="mb-10">
                                                    ...
                                                    <textarea name="metaDescription" id="metaDescription" class="form-control mb-2" cols="30" rows="5"></textarea>
                                                ...
                                                <div>
                                                    ...
                                                    <input name="metaKeywords" class="form-control mb-2">
