<?php function brandsAdd() { global $db;
    ...
    if ($_POST) {
        ...
        if ($name!='' && $description!='' && $status!='' && $metaTitle!='' && $metaDescription!='' && $metaKeywords!='') {
            $ekle = $db->exec("
    ...
    breadcrumb('Kontrol Panel','Markalar','Marka Ekleme'); ?>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="name" class="form-control mb-2" placeholder="Marka adı" value="">
                                    ...
                                    <div>
                                        ...
                                        <textarea class="form-control mb-2" name="description" id="description" cols="30" rows="10"></textarea>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10">
                                        ...
                                        <input type="text" class="form-control mb-2" name="metaTitle" placeholder="Meta etiket başlığı">

                                        <div class="text-muted fs-7">Bir meta etiket başlığı ayarlayın. Basit ve kesin anahtar kelimeler olması önerilir.</div>
                                    </div>

                                    <div class="mb-10">
                                        <label class="form-label">Meta Etiket Açıklama</label>

                                        <textarea class="form-control mb-2" name="metaDescription" id="metaDescription" cols="30" rows="5"></textarea>
                                        <div class="text-muted fs-7">Artan SEO sıralaması için markaya bir meta etiket açıklaması ayarlayın.</div>
                                    </div>

                                    <div>
                                        <label class="form-label">Meta Etiket Anahtar Kelime</label>

                                        <input id="kt_ecommerce_add_category_meta_keywords" name="metaKeywords" class="form-control mb-2" tabindex="-1">
