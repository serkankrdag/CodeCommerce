<?php function variantsAdd() { global $db;
    ...
    breadcrumb('Kontrol Panel','Varyantlar','Varyant Ekleme'); ?>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="name" class="form-control mb-2" placeholder="Varyant adı" value="">
                                                ...
                                                <div data-repeater-list="varyant">
                                                    <div data-repeater-item>
                                                        <div class="form-group row mb-5">
                                                            <div class="col-md-3">
                                                                <input name="contents" type="text" class="form-control mb-2 mb-md-0" placeholder="Bir seçenek girin" />
                                                            </div>
