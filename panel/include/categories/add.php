<?php function categoriesAdd() { global $db;
    ...
    breadcrumb('Kontrol Panel','Kategoriler','Kategori Ekleme'); ?>
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    <div class="mb-10 fv-row fv-plugins-icon-container">
                                        ...
                                        <input type="text" name="name" class="form-control mb-2" placeholder="Kategori adı" value="">
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-body pt-0">
                                    ...
                                    <div class="mb-10">
                                        ...
                                        <textarea name="metaDescription" class="form-control mb-2" id="metaDescription" cols="10" rows="5"></textarea>
                                        <div class="text-muted fs-7">Artan SEO sıralaması için kategoriye bir meta etiket açıklaması ayarlayın.</div>
                                    </div>

                                    <div>
                                        <label class="form-label">Meta Etiket Anahtar Kelimeler</label>

                                        <input name="metaKeywords" class="form-control mb-2" tabindex="-1">
