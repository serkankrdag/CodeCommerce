<?php function members() { global $db;

    $controle='';
    if(isset($_POST['sil'])){
        $id = $_POST["id"];
        $kayitSil = $db->exec("DELETE FROM members WHERE id='$id' limit 1");
        ...
        if($kayitSil) {
            $controle=
                ...
                <div class="alert alert-success d-flex align-items-success p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Üye Silindi</h4>
                        <span>Üye silme işlemi başarılı bir şekilde gerçekleşti.</span>
                    </div>
                </div>
                ';
        } elseif (!$kayitSil) {
            $controle=
                ...
                <div class="alert alert-danger d-flex align-items-danger p-5">
                    ...
                    <div class="d-flex flex-column">
                        <h4 class="mb-1 text-dark">Üye Silinemedi</h4>
                        <span>Üye silme işlemi başarısız lütfen tekrar deneyin.</span>
                    </div>
                </div>
                ';
        }
    ...
    breadcrumb('Kontrol Panel','Üyeler','Üye Listeleme'); ?>
                        ...
                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                            <div class="card-title">
                                <div class="d-flex align-items-center position-relative my-1">
                                    ...
                                    <input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Üye Ara" />
                                </div>
                                ...
                                <div class="table-responsive">
                                    <table class="table align-middle table-row-dashed fs-6 gy-5 dataTable no-footer" id="kt_datatable_example">
                                        ...
                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                            ...
                                            <th class="min-w-200px sorting" tabindex="0" aria-controls="kt_ecommerce_products_table" rowspan="1" colspan="1" aria-label="Ürün Adı" style="width: 275.812px;">Müşteri Adı</th>
                                            <th class="min-w-100px sorting" tabindex="0" rowspan="1" colspan="1" aria-label="Barkod" style="width: 139.656px;">E-posta</th>
                                            <th class="min-w-100px sorting" tabindex="0" rowspan="1" colspan="1" aria-label="Puan" style="width: 139.656px;">Adres</th>
                                        ...
                                        <?php $members = $db->query("select * from members order by id ASC")->fetchAll();
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="javascript:void(0)" class="symbol symbol-50px">
                                                        <span class="symbol-label" style="background-image:url('assets/media/svg/avatars/001-boy.svg');"></span>
                                                    </a>

                                                    <div class="ms-5">
                                                        <a href="javascript:void(0)" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name"><?=$member['name']?></a>
                                                    </div>
                                                </div>
                                            </td>
                                            ...
                                            <td class="pe-0" data-order="rating-4"><?=$member['adress']?></td>

                                            <?php $status = ($member['status'] == '1') ? '<div class="badge badge-light-success">Aktif</div>' : '<div class="badge badge-light-danger">pasif</div>'; ?>
                                            <td class="pe-0" data-order="Scheduled"><?=$status?></td>

                                            <form method="post">
                                            <input type="hidden" name="id" value="<?=$member['id']?>">
                                            <td class="text-end">
                                                <a href="membersView/<?=$member['id']?>" class="btn btn-icon btn-light-primary btn-sm"><i class="far fa-edit fs-7"></i></a>
                                                <button type="submit" class="btn btn-icon btn-light-danger btn-sm"><i class="fas fa-trash-alt fs-7"></i></button>
                                            </td>
                                            </form>
                                        </tr>
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            <div class="modal-content">
                    ...
                    <div class="modal-body py-10 px-lg-17">
                        <div class="scroll-y me-n7 pe-7" id="kt_modal_add_customer_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_customer_header" data-kt-scroll-wrappers="#kt_modal_add_customer_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <input type="text" class="form-control form-control-solid" placeholder="" name="telefon" value="" />
                            </div>
                        ...
                        <div id="kt_modal_add_customer_billing_info" class="collapse show">
                            ...
                            <div class="row g-9 mb-7">
                                <div class="col-md-6 fv-row">
                                    <label class="required fs-6 fw-semibold mb-2">Eyalet / İl</label>
                            ...
                            <div class="d-flex flex-column mb-7 fv-row">
                                ...
                                <select name="country" aria-label="Select a Country" data-control="select2" data-placeholder="Bir ülke seçin..." data-dropdown-parent="#kt_modal_add_customer" class="form-select form-select-solid fw-bold">
                                    ...
                                    <option value="ING" >İngilter</option>
                            ...
                            <div class="fv-row mb-7">
                                <div class="d-flex flex-stack">
                                    <div class="me-5">
                                        <label class="fs-6 fw-semibold">Fatura adresi olarak kullanılsın mı?</label>

                                        <div class="fs-7 fw-semibold text-muted">Daha fazla bilgiye ihtiyacınız varsa, lütfen bütçe planlamasını kontrol edin</div>
                                    </div>
                ...
                <div class="modal-footer flex-center">
                    <a href="members" class="btn btn-light me-3">
                        İptal
                    </a>
